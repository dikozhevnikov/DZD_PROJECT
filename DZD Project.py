...
# pozn. Ratioconf 1.25 nebo 0.25?
clm = cleverminer(df=df, proc='SD4ftMiner',
                  quantifiers={'FrstBase': 50, 'ScndBase': 50, 'Ratioconf': 1.25},
                  ante={
                      'attributes': [
                          {'name': 'Dependents', 'type': 'subset', 'minlen': 1, 'maxlen': 1},
                          {'name': 'Partner', 'type': 'subset', 'minlen': 1, 'maxlen': 1},
...
# Je zasadni rozdil v nejakych dvou regionech a odchodech
